...
namespace Mvckutuphane.Models.Entity
{
    ...
    public partial class DBKUTUPHANEEntities : DbContext
    {
        ...
        public virtual DbSet<TBLROLLER> TBLROLLER { get; set; }
        public virtual DbSet<TBLUYE> TBLUYE { get; set; }
        public virtual DbSet<TBLUYEROL> TBLUYEROL { get; set; }
        public virtual DbSet<TBLYAZAR> TBLYAZAR { get; set; }
    
        public virtual ObjectResult<Nullable<System.DateTime>> BugunEmanetKitap()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<System.DateTime>>("BugunEmanetKitap");
        }
